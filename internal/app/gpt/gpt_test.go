...
func Test_client_FetchCommitMessage(t *testing.T) {
	cfg := &config.Config{}
...
func Test_client_fetch_context_cancellation(t *testing.T) {
	cfg := &config.Config{}
	cfg.Model.Name = "gpt-4"
	cfg.Model.MaxTokens = 500
	cfg.Model.Temperature = 0.7
	...
	_, err := c.FetchCommitMessage(ctx, "test diff")
	assert.Error(t, err)
	assert.ErrorIs(t, err, context.Canceled)
}

func Test_client_FetchChangelog(t *testing.T) {
	cfg := &config.Config{}
	cfg.Model.Name = "gpt-4"
	cfg.Model.MaxTokens = 500
	cfg.Model.Temperature = 0.7
